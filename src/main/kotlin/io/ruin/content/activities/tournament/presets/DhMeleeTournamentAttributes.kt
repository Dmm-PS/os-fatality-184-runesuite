...
object DhMeleeTournamentAttributes : TournamentAttributes {
    ...
    override fun applyExtras(player: Player) {
        ...
        player.runePouch.set(0, Item(Preset.EARTH_RUNE, 16000))
        player.runePouch.set(1, Item(Preset.DEATH_RUNE, 16000))
        player.runePouch.set(2, Item(Preset.ASTRAL_RUNE, 16000))
