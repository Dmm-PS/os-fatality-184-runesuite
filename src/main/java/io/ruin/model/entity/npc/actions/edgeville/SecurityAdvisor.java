...
public class SecurityAdvisor {
                    ...
                    new OptionsDialogue(
                            new Option("Tell me about 2FA.", () -> player.dialogue(
                                    ...
                                    new OptionsDialogue("Open the 2FA setup page?",
                                            new Option("Yes, I'd like to secure my account.", () -> player.openUrl(World.type.getWorldName() + " 2FA", World.type.getWebsiteUrl() + "/forum/index.php?account/security")),
    ...
    static {
        NPCAction.register(5442, "check 2fa settings", (player, npc) -> player.openUrl(World.type.getWorldName() + " 2FA", World.type.getWebsiteUrl() + "/forum/index.php?account/security"));
