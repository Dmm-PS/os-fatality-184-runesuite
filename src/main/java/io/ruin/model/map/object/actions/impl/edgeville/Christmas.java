...
import io.ruin.model.inter.journal.main.SnowballPoints;
...
public class Christmas {
    ...
    static {
        ...
        if (World.christmas) {
            ...
            rewards.add(new ShopItem(20836, 200));
            rewards.add(new ShopItem(20834, 150));
            rewards.add(new ShopItem(10507, 100));

            rewards.add(new ShopItem(6856, 50));
            rewards.add(new ShopItem(6857, 50));
            rewards.add(new ShopItem(6858, 50));
            rewards.add(new ShopItem(6859, 50));
            rewards.add(new ShopItem(6860, 50));
            rewards.add(new ShopItem(6861, 50));
            rewards.add(new ShopItem(6862, 50));
            rewards.add(new ShopItem(6863, 50));

            rewards.add(new ShopItem(10836, 75));
            rewards.add(new ShopItem(10837, 75));
            rewards.add(new ShopItem(10838, 75));
            rewards.add(new ShopItem(10839, 75));
            rewards.add(new ShopItem(10840, 75));

            Shop snowballExchange = new Shop("Snowball Point Exchange", ShopCurrency.SNOWBALL_POINTS, true, rewards);
