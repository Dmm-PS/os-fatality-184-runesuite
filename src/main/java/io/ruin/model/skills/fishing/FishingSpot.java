...
public class FishingSpot {
            ...
            while(true) {
                ...
                if(c != null) {
                    if(npc.getId() == MINNOWS && (npc.minnowsFish || (npc.minnowsFish = Random.rollDie(100)))) {
                        ...
                        player.getInventory().add(c.id, npc.getId() == MINNOWS ? Random.get(10, 26) : 1);
    ...
    public static final int SMALL_NET_HARPOON = 5233;   //monkfish / swordfish
    ...
    static {
        ...
        new FishingSpot(FishingTool.SMALL_FISHING_NET)
                ...
                .register(SMALL_NET_HARPOON, "big net");
        new FishingSpot(FishingTool.HARPOON)
