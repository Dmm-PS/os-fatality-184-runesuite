...
public class CookingGuild {
    ...
    private static final int COOKING_CAPE = 9801;
    private static final int COOKING_CAPE_T = 9802;
    private static final int COOKING_HOOD = 9803;
    ...
    static {
        ...
        ObjectAction.register(24958, 3143, 3443, 0, "open", (player, obj) -> {
            if(player.getAbsY() <= 3443) {
                ...
                boolean hasCookingCape = cape == COOKING_CAPE || cape == COOKING_CAPE_T;
