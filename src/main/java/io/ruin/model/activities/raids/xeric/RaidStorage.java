...
public class RaidStorage extends ItemContainer {
    ...
    private static void upgradeStorage(Player p) {
        ...
        if (!p.getInventory().contains(Tool.HAMMER, 1) && !p.getInventory().contains(13576, 1)) {
    ...
    public static void selectStorageToBuild(Player p, int level) {
        ...
        if (!p.getInventory().contains(Tool.HAMMER, 1) && !p.getInventory().contains(13576, 1) && !p.getInventory().contains(23620, 1)) {
    ...
    public int add(int id, int amount, int uniqueValue) {
        ...
        if (def == null || !def.coxItem)
            return 0;
        return super.add(id, amount, uniqueValue);
    }
