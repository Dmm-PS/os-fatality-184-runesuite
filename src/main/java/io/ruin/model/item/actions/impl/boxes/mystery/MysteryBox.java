...
public class MysteryBox {
    ...
    private static final LootTable MYSTERY_BOX_TABLE = new LootTable().addTable(1,
            ...
            new LootItem(4716, 1, 50), //Dharok's helm
            new LootItem(4720, 1, 50), //Dharok's platebody
            new LootItem(4722, 1, 50), //Dharok's platelegs
            new LootItem(4718, 1, 50), //Dharok's greataxe
            new LootItem(4736, 1, 50), //Karil's leathertop
            new LootItem(13442, 100, 250, 25), //100 Anglerfish
            new LootItem(11235, 1, 25), //Dark bow
            new LootItem(8927, 1, 25), //Bandana eyepatch
            new LootItem(2643, 1, 25), //Dark cavalier
            new LootItem(12301, 1, 25), //Blue headband
            new LootItem(2577, 1, 25), //Ranger boots
