...
public class MagicSkillcape {
    ...
    private static final int CAPE = 9762;
    private static final int TRIMMED_CAPE = 9763;
    ...
    private static void swapSelection(Player player, Item item) {
        ...
        if(player.magicSkillcapeUses >= 15) {
            player.sendMessage("You've already used spellbook swap 15 times today. You can use this again in another " + getRemainingTime(player) + ".");
            return;
        }
