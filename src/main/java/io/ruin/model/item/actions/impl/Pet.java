...
public enum Pet {
     ...
     * Boss pets
     */
    ABYSSAL_ORPHAN(13262, 5884, true, 1000),
    BABY_MOLE(12646, 6635, true, 1000),
    CALLISTO_CUB(13178, 5558, true, 500),
    HELLPUPPY(13247, 3099, true, 1000),
    ...
    static {
        for (Pet pet : values()) {
            ...
            if (talkAction == null)
                System.err.println(ItemDef.get(pet.itemId).name + " (" + pet.itemId + ") pet has no dialogue!");
            else {
