...
public class LoginInfo {
    ...
    public LoginInfo(String ip, String name, String password, String email, int tfaCode, boolean tfaTrust, int tfaTrustValue) {
        this.channel = null;
        this.ipAddress = ip;
    ...
    public LoginInfo(Channel channel, String name, String password, String email, int tfaCode, boolean tfaTrust, int tfaTrustValue, int worldId, int[] keys) {
