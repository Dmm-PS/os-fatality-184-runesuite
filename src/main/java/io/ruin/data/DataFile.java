...
public interface DataFile {
    ...
    Object fromJson(String fileName, String json);
    ...
    static void loadPacked() throws Exception {
    ...
    static List<PackedFile> load(DataFile dataFile) throws Exception {
        /**
         * Load unpacked files
         */
    ...
    static void reload(Player player, Class<? extends DataFile> c) {
    ...
    final class PackedFile {
        ...
        PackedFile(DataFile dataFile, File unpackedFile) throws IOException {
            ...
            if (Server.dataOnlyMode) {
                ...
                json = JsonUtils.GSON_EXPOSE.toJson(dataFile.fromJson(fileName, JsonUtils.fromFile(unpackedFile)));
            }
        }
    ...
    static int priority(String dataName, int priority) {
